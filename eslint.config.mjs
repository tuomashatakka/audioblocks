...
import blockPaddingPlugin from 'eslint-plugin-block-padding'
...
const plugins = {
  ...
  'block-padding':   blockPaddingPlugin,
}
...
const config = {
  ...
  rules:   {
    ...
    '@stylistic/indent': [
      'warn',
      2,
      { SwitchCase: 1, offsetTernaryExpressions: false, flatTernaryExpressions: true, CallExpression: { arguments: 'first' }},
    ],
